...
def threeD_test(args=[]):
    ...
    my_animation.setup(
        obstacle_environment_list = [obstacle_environment_lower, obstacle_environment_upper],
    ...
    assert chair_back_agent.stop == True, "Expect to stop all agent sections once one section has emergency stop triggered!"
