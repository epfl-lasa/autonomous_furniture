...
def multiple_smart_furniture():
    ...
    init_pos_furniture = [np.array([1, -0.42]), np.array([-1, -0.42]), np.array([1, 0.42]), np.array([-1, 0.42]), np.array([0, 0]), np.array([3, -0.4])]
    init_ori_furniture = [pi, 0, pi, 0, pi/2, 0]
    init_vel_furniture = [np.array([0, 0]), np.array([0, 0]), np.array([0, 0]), np.array([0, 0]), np.array([0, 0]), np.array([-0.3, 0.])]
    goal_pos_furniture = [np.array([1, -0.42]), np.array([-1, -0.42]), np.array([1, 0.42]), np.array([-1, 0.42]), np.array([0, 0]), np.array([3, -0.4])]
