...
def priority_demo():
    ...
    my_furniture = [Person(center_position=[2, 5.5],
                           radius=0.8, obstacle_environment=obstacle_environment, goal_pose=goal2,priority_value=1000, margin=1, static=True, name="pers"),
                    ...
                    Furniture(shape=table_shape2, obstacle_environment=obstacle_environment, control_points=np.array([[0,0],[0,0]]), goal_pose=goal2, priority_value=0.01, static=True, name="static")]  
