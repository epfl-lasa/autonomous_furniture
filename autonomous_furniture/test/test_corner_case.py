...
def run_single_furniture_rotating():
    ...
    goal2 = ObjectPose(position=np.array([3.5, 1]), orientation=0)
    ...
    my_furniture = [Person(center_position=[3.5, 1],
                    radius=0.8, obstacle_environment=obstacle_environment, goal_pose=goal2,priority_value=1,name="1"), Furniture(shape=table_shape,
